...
module.exports = eval("require")("html-to-md");
...
// EXTERNAL MODULE: ./node_modules/@vercel/ncc/dist/ncc/@@notfound.js?html-to-md
var _notfoundhtml_to_md = __nccwpck_require__(7137);
    ...
    if (rss?.items?.length) {
      ...
      const blocks = toSend.map(item => {
        ...
        if (!unfurl) {
          ...
          if (item.description) {
            const description = _notfoundhtml_to_md(item.description)
